...
// import 'package:network_info_plus/network_info_plus.dart'; // <-- DEĞİŞİKLİK: Bu paket kodda hiç kullanılmadığı için kaldırıldı. Windows derlemesinde gereksiz sorunları önler.
...
    ENTRY
    ======================= */
// <-- DEĞİŞİKLİK: main fonksiyonu, Windows gibi masaüstü platformlarında
// gerekli olan 'async' ve 'WidgetsFlutterBinding.ensureInitialized()' yapısıyla güncellendi.
...
        _OptionItem(id: 'double_mozza',   label: 'Double Mozzarella rapee',      price: 3.00),
...
                  onPressed: () async {
                    try {
                      // <-- DEĞİŞİKLİK: Fonksiyon adı daha genel olması için 'printOrder' olarak değiştirildi.
                      await printOrder(o);
...
// <-- DEĞİŞİKLİK: Fonksiyonun adı 'printOrderAndroid' yerine daha genel olan 'printOrder' olarak değiştirildi.
// Bu fonksiyonun içindeki ağ (socket) tabanlı yazdırma mantığı zaten Windows, macOS, Linux ve
// Android/iOS üzerinde değişiklik yapmadan çalışır.
